...
* The original package name 'com.bomrautft.common-util' is invalid and this project uses 'com.bomrautft.common_util' instead.
...
* [Spring Web Services](https://docs.spring.io/spring-boot/3.5.10-SNAPSHOT/reference/io/webservices.html)
